...
void
UiSprite9::SetImage( const Ogre::String& image )
{
    Ogre::Pass* pass = m_Material->getTechnique( 0 )->getPass( 0 );
...
UiSprite9::CreateVertexBuffer()
{
    ...
    m_VertexBuffer = Ogre::HardwareBufferManager::getSingletonPtr()->createVertexBuffer( vDecl->getVertexSize( 0 ), 6 * 9, Ogre::HardwareBuffer::HBU_DYNAMIC_WRITE_ONLY, false );
